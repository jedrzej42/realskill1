# PostgreSQL simple exercise

## Goals

This exercise have 4 simple PostgreSQL tasks.
...
Search `first_name`, `last_name` and `age` of users who are underage. 

### unemployed.sql

Count every unemployed user.
